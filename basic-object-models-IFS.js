 ...
 */
  ...
  */
 function uvPrism(length, width, height) {
    var l = (length || 1)/2;
    var w = (width || 1)/2;
    var h = (height || 1)/2;
    var coords = [];
    ...
    face( [-w,-l,h, w,-l,h, w,l,h, -w,l,h], [0,0,1] );
    face( [-w,-l,-h, -w,l,-h, w,l,-h, w,-l,-h], [0,0,-1] );
    face( [-w,l,-h, -w,l,h, w,l,h, w,l,-h], [0,1,0] );
    face( [-w,-l,-h, w,-l,-h, w,-l,h, -w,-l,h], [0,-1,0] );
    face( [w,-l,-h, w,l,-h, w,l,h, w,-l,h], [1,0,0] );
    face( [-w,-l,-h, -w,-l,h, -w,l,h, -w,l,-h], [-1,0,0] );
    return {
  ...
  */
 function uvRing(innerRadius, outerRadius, slices) {
 ...
 /**
  * Defines a model of a 3d hexagon. The axis of the hexagon is the z-axis,
  * and the center is at (0,0,0).
  * @param length of center of hexagon to each vertex
  * @param thickness of hexagon.
  * @param noTop variable that represents if the top should be drawn or noTop
  * @param noBottom variable that represents if the bottom should be drawn or noTop
  */
 function uvHexagon(length, thickness, noTop, noBottom) {
    length = length || 1;
    thickness = thickness || length/2;
    var slices = 6;
    var vertexCount = 2*(slices+1);
    if (!noTop)
       vertexCount += slices + 2;
    ...
    for (i = 0; i <= slices; i++) {
       ...
       var c = Math.cos(u);
       var s = Math.sin(u);
       vertices[kv] = c*length;
       normals[kv++] = c;
       vertices[kv] = s*length;
       normals[kv++] = s;
       vertices[kv] = -thickness/2;
       normals[kv++] = 0;
       texCoords[kt++] = i/slices;
       texCoords[kt++] = 0;
       vertices[kv] = c*length;
 ...
 /**
  * Defines a model of a 3d octagon. The axis of the octagon is the z-axis,
  * and the center is at (0,0,0).
  * @param length of center of octagon to each vertex
  * @param thickness of octagon.
  * @param noTop variable that represents if the top should be drawn or noTop
  * @param noBottom variable that represents if the bottom should be drawn or noTop
  */
 function uvOctagon(length, thickness, noTop, noBottom) {
    length = length || 1.2;
    thickness = thickness || length/1.5;
    var slices = 8;
    var vertexCount = 2*(slices+1);
    if (!noTop)
       vertexCount += slices + 2;
